...
//        }
        ...
        // gravity field asteroids
        double convertAUperdayToSI =
        ...
        std::cout<<"conversion:"<<convertAUperdayToSI<<std::endl;
...
//        Eigen::VectorXd observationWeightDiagonal = podOutput->weightsMatrixDiagonal_; // diagonal of W
        ...
        Eigen::MatrixXd partialDerivativesWrtAsteroidGravitationalParameters
                = unnormalizedPartialDerivatives.block(0,6,unnormalizedPartialDerivatives.rows(),unnormalizedPartialDerivatives.cols()-6);
        input_output::writeMatrixToFile( partialDerivativesWrtAsteroidGravitationalParameters,
                                         "partialDerivativesWrtAsteroidGravitationalParameters.dat", 16, outputSubFolder );
